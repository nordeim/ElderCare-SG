...
| Frontend Stack    | TailwindCSS, Alpine.js (via Blade)   | `package.json`, `Understanding Codebase Architecture and Status.md` |
...
- Directory Structure:  
  `app/Http/Controllers`, `app/Models`, `app/Services`, `app/Jobs`, `app/Support/Metrics`, `app/Notifications`, `app/Policies`.  
  The `app/Domain` directory does not exist.
...
## Core Logic Walkthrough: The Booking Flow
